// Script para crear un pedido de prueba y luego facturarlo
...
async function createTestOrderAndInvoice() {
  try {
    ...
    // 3. Actualizar el pedido con los items
    ...
    // 4. Ahora crear la factura con Holded
    ...
    if (invoiceData.success) {
      ...
      console.log('👤 Cliente:', invoiceData.invoice.customer_name)
